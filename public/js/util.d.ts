...
export declare const uciToMove: (
...
export declare const pawnDirCapture: (
   x1: number,
   y1: number,
   x2: number,
   y2: number,
...
export declare const pawnDirAdvance: (
   x1: number,
   y1: number,
   x2: number,
   y2: number,
 ...
 */
export declare const squaresBetween: (
   x1: number,
   y1: number,
   x2: number,
   y2: number,
...
export declare const squareShiftedVertically: (
   square: cg.Key,
   delta: number,
) => cg.Key | undefined;
